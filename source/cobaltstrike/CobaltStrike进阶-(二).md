...
![image](.././images/cobaltstrike/986E795ADF7E48BDADB2CD12DDEDB731)
...
**1. 最基本的多团队服务器模型**
![image](.././images/cobaltstrike/6D1E307EC948453380655C891378C75E)
...
团队服务器等多个团队服务器。
![image](.././images/cobaltstrike/99D3516526F3499A97E1B057D672590C)

**3. 具有权限管理单元的多团队服务器模型**
![image](.././images/cobaltstrike/DC05F34D83054880B7374C86F29F0FBD)
...
![image](.././images/cobaltstrike/404654ED60BF4C0081325255E124FD91)
...
![image](.././images/cobaltstrike/D5CE7C105CE54741AB842FF4EA1EED85)

不足: 现在的CS中(4.0版本之前), 比较常用的C2通信方式是使用方向shell和反向HTTP C2通道。 然后随着时间和防御水平的提高，这种方法势必越难以生效，因此需要外部C2通信方式来替代C2自带的传统通信方式。
![image](.././images/cobaltstrike/24F942FF4A1448BAB3D813A22EF06240)
![image](.././images/cobaltstrike/BC131FD751AF4EFF93343E4D9B6C07FC)
...
![image](.././images/cobaltstrike/C406A70EA1D54E79831296092E03CBBC)
...
1. 配置Web服务器和钓鱼链接
![image](.././images/cobaltstrike/E7D589C2358B49D6B3BE251043ADAC65)
2. 打开View/Web log和Application，用户点击钓鱼链接后即可得到目标信息。

![image](.././images/cobaltstrike/2DD2568AA17E417DADE41520C872C6F6)
